...
import XMonad.Layout.ResizableTile -- resize slave tiles
import XMonad.Hooks.DynamicLog -- status on bar
import XMonad.Layout.Fullscreen -- alows windows to go fullscreen (youtube)
...
-- * EwmhDesktops users import XMonad.Hooks.WorkspaceHistoryshould change this to ewmhDesktopsEventHook
--
...
--
main =  do
  xmproc <- spawnPipe "xmobar /home/colby/.config/xmobar/xmobarrc"
